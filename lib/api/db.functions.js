...
export const loadSetups = database => new Promise((resolve, reject) => {
    database
...
export const saveSetup = (database, setup) => new Promise((resolve, reject) => {
...
export const deleteSetup = (database, id) => new Promise((resolve, reject) => {
    database
      .collection(collections.SETUPS)
...
export const clearSetups = database => new Promise((resolve, reject) => {
